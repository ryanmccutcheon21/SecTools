...
def fgsm_attack(model: nn.Module, images: Tensor, labels: Tensor, epsilon: float) -> Tensor:
    """Standard FGSM attack in normalized space.

    Args:
        model: Neural network classifier
        images: Input images in normalized space
